...
@Component({
  selector: 'app-skate-track',
  templateUrl: './skate-track.component.html',
  styleUrls: ['./skate-track.component.scss']
})
export class SkateTrackComponent implements OnInit {
  //TYPE SCENARIOS
  //  opt = Options
