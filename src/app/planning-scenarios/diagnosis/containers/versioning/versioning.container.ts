 ...
 */
 @Component({
  selector: 'app-versioning-container',
  templateUrl: './versioning.container.html',
  styleUrls: ['./versioning.container.scss']
})
export class VersioningContainer implements OnInit {
  dataSource: any;
  //Configuracion de la Card
  configCard = {
    title: "Versionamiento de Diagnósticos",
    btnName: "",
    routerLinkBtn: "/escenarios-planeacion/diagnostico/crear",
  };
  ...
  columnsNamesToDisplay = [
    ...
    { name: "prioridad", display: "PRIORIDAD" },
    { name: "calificacion", display: "CALIFICACIÓN" },
    { name: "intervenciones", display: "INTERVENCIONES" },
  ...
  configDisplayElement = {
    ...
    actions: [
      ...
      {
        action: "edit",
        actionsLink: "/escenarios-planeacion/diagnostico/versionamiento/editar",
      },
    ],
  };
  configPaginator = {
