 ...
 */
 @Component({
  selector: 'app-diagnosis-container',
  templateUrl: './diagnosis.container.html',
  styleUrls: ['./diagnosis.container.scss']
})
export class DiagnosisContainer implements OnInit {
  dataSource: any;
  //Configuracion de la Card
  configCard = {
    title: "Diagnósticos",
    btnName: "Crear Diagnóstico",
  ...
  configDisplayElement = {
    ...
    actions: [
      ...
      {
        action: "edit",
        actionsLink: "/escenarios-planeacion/diagnostico/editar",
      },
    ],
  };
  configPaginator = {
